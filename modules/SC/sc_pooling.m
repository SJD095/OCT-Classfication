...
dSize = size(B, 2);% size of the dictionary
nSmp = size(feaSet.feaArr, 2);%number of total patches of an image
img_width = feaSet.width;%width of the image 
img_height = feaSet.height;%height of the image 
idxBin = zeros(nSmp, 1);

sc_codes = zeros(dSize, nSmp);%the discriptor of the image 
